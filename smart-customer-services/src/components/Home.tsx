    ...
    <div className="home">
      ...
      <div className="home-content">
        ...
        <div className="about">
          ...
          <p id="about-desc">
            SCS is an online system that aims to plan for smart green trips
            ...
            threat to the quality of life these years, the world has been
            looking for various solutions to decrease the stress, frustration,
            delays and terrible air pollutions being caused through it. SCS
            attempts to provide a smart green solution on this regard by
            providing online shopping services and then delivery of the
            purchased items from the warehouses selected/close to the
            destination address.
          </p>
        </div>
